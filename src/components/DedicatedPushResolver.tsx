...
export function DedicatedPushResolver({
  ...
  return (
    <div className="fixed inset-0 z-[9999999] bg-[#09090b] flex flex-col justify-between p-4 sm:p-6 md:p-8 overflow-y-auto">
      {/* Top Header */}
      <div className="max-w-md w-full mx-auto flex items-center justify-between border-b border-border/40 pb-4 shrink-0">
      ...
      <motion.div
        ...
        className="max-w-md w-full mx-auto my-auto space-y-4 py-4 font-mono text-xs"
      >
        {/* Amount Banner */}
        <div className="p-4 bg-card/60 border border-border rounded-xl flex items-center justify-between shadow-sm">
        ...
        {transaction.raw_text && (
          <div className="text-[10px] text-muted-foreground/80 bg-secondary/20 p-3 rounded-lg border border-border/40 truncate">
        ...
        <div className="space-y-1.5">
          ...
          <Input
            ...
            className="h-11 rounded-lg font-mono text-sm bg-secondary/30 border-border focus-visible:ring-1 focus-visible:ring-foreground"
          />
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <div className="grid grid-cols-2 gap-1.5 max-h-36 overflow-y-auto p-1 border border-border/40 rounded-lg bg-secondary/10">
            {categories.map((c) => {
        ...
        <div className="flex items-center gap-2 pt-1 cursor-pointer select-none" onClick={() => setCreateRule(!createRule)}>
          <input
            type="checkbox"
            checked={createRule}
      ...
      {/* Bottom Actions */}
      <div className="max-w-md w-full mx-auto pt-4 border-t border-border/40 flex items-center gap-2.5 shrink-0">
        <Button
          type="button"
          variant="outline"
          onClick={handleDismiss}
          className="w-1/3 h-11 rounded-lg border-border font-mono text-xs uppercase font-bold cursor-pointer"
        >
          Cancel
        </Button>
        <Button
          ...
          onClick={handleSave}
          className="w-2/3 h-11 rounded-lg bg-foreground text-background hover:bg-foreground/90 font-mono text-xs uppercase font-bold tracking-wider cursor-pointer flex items-center justify-center gap-2 shadow-lg"
        >
