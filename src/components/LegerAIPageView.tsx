...
export function LegerAIPageView({ cycleData, expenses, categories }: LegerAIPageViewProps) {
  ...
  return (
    <div className="mx-auto max-w-5xl p-4 md:p-8 space-y-8 md:space-y-12 pb-24 text-foreground w-full">
        ...
        <div className="lg:col-span-1 space-y-6 lg:space-y-12">
           <div className="space-y-6">
               <div className="flex justify-between items-center border-b border-border pb-2">
                  <h3 className="technical-label text-foreground/70">Session Telemetry</h3>
                  <div className="flex items-center gap-1.5">
                     <span className={cn(
                       "w-1.5 h-1.5 rounded-full animate-pulse",
                       isLoading ? "bg-amber-500 shadow-[0_0_8px_#f59e0b]" :
                       analysis?.threatLevel > 70 ? "bg-destructive shadow-[0_0_8px_#ef4444]" :
                       "bg-emerald-500 shadow-[0_0_8px_#10b981]"
                     )} />
                     <span className="text-[8px] font-mono opacity-50 uppercase">{isLoading ? "SYNC" : "LIVE"}</span>
                  </div>
               </div>
               <div className="space-y-4">
           ...
           <div className="p-6 bg-secondary/10 border border-border ledger-border space-y-4 shadow-sm">
              ...
              <div className={cn(
                ...
                analysis?.status === "HEALTHY" ? "bg-emerald-600 dark:bg-emerald-500 text-white border-emerald-600 shadow-[0_0_10px_rgba(16,185,129,0.2)]" :
         ...
         <div className="lg:col-span-2 space-y-8">
                       ...
                       <div className="space-y-6 flex-1">
                          <AnimatePresence mode="wait">
                             <motion.p 
                               ...
                               className="text-xl md:text-2xl font-medium tracking-tight leading-relaxed text-foreground/90"
                             >
                               {displayMessage}
                             </motion.p>
                          </AnimatePresence>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 pt-4">
               <div className="p-4 sm:p-6 border border-border ledger-border bg-secondary/5 space-y-2 transition-all duration-300 hover:bg-secondary/10 hover:border-foreground/30 hover:shadow-sm cursor-default">
               ...
               <div className={cn(
                 "p-4 sm:p-6 border border-border ledger-border space-y-2 transition-all duration-300 hover:shadow-sm cursor-default",
                 cycleData.velocity > 1.0 
                   ? "bg-destructive/5 hover:bg-destructive/10 hover:border-destructive/30" 
                   : "bg-emerald-500/5 hover:bg-emerald-500/10 hover:border-emerald-500/30"
               )}>
