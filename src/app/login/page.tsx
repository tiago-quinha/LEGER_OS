...
import { Landmark, Terminal, Lock, User, Mail, ArrowRight, Sparkles } from "lucide-react"
          ...
          <CardContent className="pt-8">
            <form onSubmit={handleLogin} className="space-y-6">
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <Input 
                    ...
                    required
                    className="pl-10 rounded-none border-border focus:border-foreground focus:ring-0 h-12 font-mono text-sm"
                  />
                </div>
              </div>
              ...
              <Button 
                type="submit" 
                disabled={isLoading}
                className="w-full h-12 rounded-none bg-foreground text-background hover:bg-foreground/90 uppercase text-[10px] font-bold tracking-[0.2em] gap-2"
              >
            ...
            <div className="mt-8 pt-6 border-t border-border/50 text-center space-y-4">
               ...
               >
                 Create Mainframe ID <Sparkles className="h-3 w-3 group-hover:animate-pulse" />
               </Link>
            </div>
          </CardContent>
        </Card>
